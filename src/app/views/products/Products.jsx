...
class Products extends React.Component {
  ...
  render() {
    ...
    const { editing, disableEdit, searching,createForm, editForm , creating,disableCreate} = this.state;
    ...
    return (
      <div className="m-sm-30">
        ...
        <SimpleCard createButton ={
          <Button variant="contained" onClick={this.showCreateForm} color="primary">
          Add Product
        </Button>
        }>
        <div className="py-8">
        ...
        {createForm && (
          <CreateModal
            ...
            content={
              <ProductCreate productCreateData={productCreateData} handleInputChange={this.handleInputChange} classes={classes} />
            }
          />
        )}
      </div>
