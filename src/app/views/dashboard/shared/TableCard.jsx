...
const TableCard = (props) => {
  ...
  >
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell align="left" className="px-10">Total Amount</TableCell>
            <TableCell align="left">Total Orders</TableCell>
            <TableCell align="left">Customer Name</TableCell>
            <TableCell align="left" className="px-10">Customer Phone</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {topCustomers.map((top,index) => (
            <TableRow key={index}>
              <TableCell component="th" align="left"className="px-10" className="px-10" scope="row">
              {top.totalAmount}
              </TableCell>
              ...
              <TableCell align="left"className="px-10">{top.customer.phone}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
